        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Card sx={{
              ...
              <CardMedia
                sx={{ height: 140 }}
                image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8A1lu6X-3G6b5IsUIG25it6Qi84b8n8scoA&s"
                title="green iguana"
              />
              <CardContent sx={{ p: 1.5, '&:last-child': { p: 1.5 } }}>
                <Typography> GiaDuc DangCap </Typography>
              </CardContent>
