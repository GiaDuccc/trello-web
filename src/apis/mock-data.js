  ...
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://gratisography.com/wp-content/uploads/2025/01/gratisography-dog-vacation-800x525.jpg',
      ...
      },
      {
        ...
        // Cấu trúc Id của cái card này dễ Unique rất đơn giản, không cần phải làm random phức tạp:
